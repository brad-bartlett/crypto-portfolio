      ...
      <div>
        ...
        <form>
          <div className="form-group">
            ...
            <input onChange={this.props.handleChange} autoComplete="off" type="text" name="name" placeholder="Ex: Bitcoin, Tezos, Ethereum..." value={this.props.name} className="field"/>
          </div>
